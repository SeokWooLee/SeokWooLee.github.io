---
title: "Swift 빌더 패턴(Builder Pattern)으로 매개변수 8개 초기화 지옥 탈출하기"
description: "Swift로 앱을 만들다 보면 어느 순간 초기화 코드가 이렇게 변해 있습니다."
header:
  og_image: /assets/images/posts/7d525bb6-3e20-432c-9a7f-7236a98d4ff3/1.jpg
tags:
  - Swift
  - 빌더패턴
  - 디자인패턴
...
<figure>
  <img src="/assets/images/posts/7d525bb6-3e20-432c-9a7f-7236a98d4ff3/1.jpg" alt="Swift 빌더 패턴 쓰기 전과 후, 초기화 코드가 이렇게 갈립니다" width="1200" height="800" loading="eager" fetchpriority="high" decoding="async">
...
<figure>
  <img src="/assets/images/posts/7d525bb6-3e20-432c-9a7f-7236a98d4ff3/4-1783847733231.png" alt="체이닝 호출이 실제로는 이렇게 흘러가요" width="1200" height="785" loading="lazy" decoding="async">
  <figcaption>체이닝 호출이 실제로는 이렇게 흘러가요</figcaption>
</figure>

<figure>
  <img src="/assets/images/posts/7d525bb6-3e20-432c-9a7f-7236a98d4ff3/2.jpg" alt="빌더 하나 붙여놓고 커피 마시면서 정리했더니 마음이 편하더라고요" width="1200" height="1200" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/7d525bb6-3e20-432c-9a7f-7236a98d4ff3/3.jpg" alt="이름표 붙은 메서드로 이어 쓰니 순서 걱정이 사라졌어요" width="1024" height="1024" loading="lazy" decoding="async">
