---
title: "Swift 플라이웨이트 패턴(Flyweight Pattern), 객체 공유로 메모리 아끼는 법"
description: "앱을 만들다 보면 비슷비슷한 객체를 수천, 수만 개씩 찍어내야 할 때가 있어요. 지도 위에 마커를 수만 개 뿌리는 기능이 대표적인데, 이런 상황에서는 메모리 그래프가 계속 치솟기 쉽습니다."
header:
  og_image: /assets/images/posts/efce9355-5a70-44ad-9411-90fab3419bf4/1.jpg
tags:
  - Swift
  - 플라이웨이트패턴
  - 디자인패턴
...
<figure>
  <img src="/assets/images/posts/efce9355-5a70-44ad-9411-90fab3419bf4/1.jpg" alt="Swift 플라이웨이트 패턴, 100만 그루도 종류는 딱 3개면 됩니다" width="1200" height="800" loading="eager" fetchpriority="high" decoding="async">
...
<figure>
  <img src="/assets/images/posts/efce9355-5a70-44ad-9411-90fab3419bf4/2.jpg" alt="그날 마커 뿌리다 메모리 치솟는 거 보고 한참을 붙잡고 있었어요" width="1024" height="1024" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/efce9355-5a70-44ad-9411-90fab3419bf4/4-1783847779486.png" alt="팩토리가 쥐고 있고, 나무는 참조만 들고 다니는 구조예요" width="764" height="852" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/efce9355-5a70-44ad-9411-90fab3419bf4/3.jpg" alt="숲 전체를 그려도 텍스처는 세 개만 공유하면 끝나더라고요" width="1024" height="1024" loading="lazy" decoding="async">
