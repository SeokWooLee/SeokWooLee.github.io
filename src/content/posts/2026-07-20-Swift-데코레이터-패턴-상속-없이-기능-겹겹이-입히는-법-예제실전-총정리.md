---
title: "Swift 데코레이터 패턴(Decorator Pattern), 상속 없이 기능 겹겹이 입히는 법"
description: "iOS 개발하다 보면 이런 순간이 옵니다. 기본 기능은 그대로 두고 로깅 하나만, 캐싱 하나만 얹고 싶은데, 그걸 하려고 클래스를 상속받기 시작하면 어느새 상속 트리가 엉망이 되어 있죠."
header:
  og_image: /assets/images/posts/693f4da4-c7cb-4afb-b47c-adae41cf9d3c/1.jpg
tags:
  - Swift
  - 데코레이터패턴
  - 디자인패턴
...
<figure>
  <img src="/assets/images/posts/693f4da4-c7cb-4afb-b47c-adae41cf9d3c/1.jpg" alt="Swift 데코레이터 패턴, 상속 없이 이렇게 한 겹씩 감쌉니다" width="1200" height="800" loading="eager" fetchpriority="high" decoding="async">
...
<figure>
  <img src="/assets/images/posts/693f4da4-c7cb-4afb-b47c-adae41cf9d3c/2-1783772343669.jpg" alt="자기 일만 하고 나머지는 안쪽 객체에 위임하는 구조예요" width="1024" height="1024" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/693f4da4-c7cb-4afb-b47c-adae41cf9d3c/4-1783847764924.png" alt="겹겹이 감싼 만큼 호출도 한 겹씩 내려갑니다" width="1200" height="819" loading="lazy" decoding="async">
  <figcaption>겹겹이 감싼 만큼 호출도 한 겹씩 내려갑니다</figcaption>
</figure>

<figure>
  <img src="/assets/images/posts/693f4da4-c7cb-4afb-b47c-adae41cf9d3c/3.jpg" alt="안쪽부터 네트워크·캐싱·로깅 순으로 겹쳐진 모습입니다" width="1024" height="1024" loading="lazy" decoding="async">
