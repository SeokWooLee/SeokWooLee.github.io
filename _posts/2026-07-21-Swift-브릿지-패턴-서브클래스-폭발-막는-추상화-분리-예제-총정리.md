---
title: "Swift 브릿지 패턴(Bridge Pattern), 서브클래스 폭발 막는 추상화 분리"
description: "Swift로 앱을 만들다 보면 클래스가 한없이 늘어나는 순간이 옵니다."
header:
  og_image: /assets/images/posts/b092514a-da27-457a-bbef-296f806dcf40/1.jpg
tags:
  - 스위프트
  - Swift
  - 브릿지패턴
...
<figure>
  <img src="/assets/images/posts/b092514a-da27-457a-bbef-296f806dcf40/1.jpg" alt="브릿지 패턴으로 바꾸니 클래스가 12개에서 7개로 줄었어요" width="1200" height="800" loading="eager" fetchpriority="high" decoding="async">
...
<figure>
  <img src="/assets/images/posts/b092514a-da27-457a-bbef-296f806dcf40/4-1783847750420.png" alt="리모컨은 기기를 상속 안 하고 들고만 있어요" width="420" height="1204" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/b092514a-da27-457a-bbef-296f806dcf40/2-1783771894982.jpg" alt="곱셈으로 늘던 클래스가 다리 하나로 덧셈이 됩니다" width="1024" height="1024" loading="lazy" decoding="async">
...
<figure>
  <img src="/assets/images/posts/b092514a-da27-457a-bbef-296f806dcf40/3.jpg" alt="축이 두 개다 싶으면 이렇게 갈라놓는 게 편하더라고요" width="1024" height="1024" loading="lazy" decoding="async">
